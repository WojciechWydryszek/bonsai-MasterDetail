...
public class AdapterQr extends RecyclerView.Adapter<AdapterQr.ViewHolder> {

    private ArrayList<Bonsai> bonsaiArrayList;
    private Context activityParent;

    public AdapterQr(ArrayList<Bonsai> bonsaiArrayList) { this.bonsaiArrayList = bonsaiArrayList; }

    public AdapterQr(ArrayList<Bonsai> bonsais, Context activity) {
    ...
    @NonNull
    @Override
    public AdapterQr.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_gallery, parent, false);

        return new AdapterQr.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterQr.ViewHolder item, @SuppressLint("galleryRecyclerView") int position) {
